...
public class ChronomancerEngine {
    ...
    public VaultRunResult runVault(List<Hero> party) {
        ...
        System.out.println("\n Inventory with " + vaultInventory.size() + " artifacts loaded.");


        System.out.println("\n [VISITOR] Applying 4 different appraisers:");
        ...
        System.out.println("\n Total value: " + appraiser.getTotalValue() + " gold");
        System.out.println("  Total weight: " + weightCalc.getTotalWeight() + " kg");


        System.out.println("\n TRAP ACTIVATED! Hero damaged!");
        hero.takeDamage(75);
        hero.spendMana(40);
        ...
        System.out.println("\n [MEMENTO] Rewinding time...");
        HeroMemento saved = caretaker.undo();
        if (saved != null) {
            hero.restoreFromMemento(saved);
            System.out.println("   Hero successfully restored!");
        }
